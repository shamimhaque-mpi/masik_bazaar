...
@section('fav_title', __('backend/books_request.books_request') )
...
<div class="app-title">
	...
	<ul class="app-breadcrumb breadcrumb">
		...
		<li class="breadcrumb-item active">{{ __('backend/books_request.books_request') }}</li>
	</ul>
</div>
	...
	<div class="col-md-12">
		<div class="card">
			...
			<div class="card-header">
				<div class="row">
					<div class="col-md-6"><h2><i class="{{ 'fa fa-table' }}"></i> {{ __('backend/books_request.books_request_list') }}</h2></div>
			...
			<div class="card-body">
				...
				<div class="toggle-table-column">
					...
					<a href="#" class="toggle-vis" data-column="4"><b>{{ __('backend/books_request.author_book') }}</small></b></a> |
