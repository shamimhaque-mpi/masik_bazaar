...
@section('fav_title', __('backend/distributor.edit_distributor') )
	...
	<div class="col-md-12">
		<div class="card">
			<div class="card-header">
				<div class="row">
					<div class="col-md-6"><h2><i class="{{ 'fa fa-pencil-square' }}"></i> {{ __('backend/distributor.edit_distributor') }}</h2></div>
			...
			<div class="card-body">
				...
				<form class="form-horizontal" action="{{ route('admin.distributor.update',$row->id) }}" method="post" enctype="multipart/form-data">
					@csrf
					...
					<div class="form-group row">
						...
						<div class="col-md-5">
							<input id="name" class="form-control" type="text" name="name" value="{{ $row->name }}" required placeholder="Name">
						</div>
					</div>
					<div class="form-group row">
						<label class="control-label col-md-3 text-right mt-2" for="shop_name">{{ __('backend/distributor.shop_name') }}</label>
						<div class="col-md-5">
							<input id="shop_name" class="form-control" type="text" name="shop_name" value="{{ $row->shop_name }}" placeholder="Name">
						</div>
					</div>
					<div class="form-group row">
						...
						<div class="col-md-5">
							<input id="mobile" class="form-control" type="text" name="mobile" value="{{ $row->mobile }}" required placeholder="Mobile no...">
						</div>
					</div>
					<div class="form-group row">
						...
						<div class="col-md-5">
							<textarea name="address" id="address" class="form-control" rows="6" type="text" required placeholder="Address...">{{ $row->address }}</textarea>
						</div>
					</div>
