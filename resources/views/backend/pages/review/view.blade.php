...
@section('fav_title', __('backend/review.view_review') )
	...
	<div class="col-md-12">
		<div class="card">
			...
			<div class="card-header">
				<div class="row">
					<div class="col-md-6"><h2><i class="{{ 'fa fa-eye' }}"></i> {{ __('backend/review.view_review') }}</h2></div>
					{{-- <div class="col-md-6">
						<div class="btn-group float-right">
							<a href="{{ route('admin.review.index') }}" class="btn btn-primary"><i class="fa fa-arrow-left"></i> {{ __('backend/default.list') }}</a><a href="{{ route('admin.review.edit',$row->id) }}" class="btn btn-warning"><i class="fa fa-edit"></i> {{ __('backend/default.edit') }}</a>
						</div>
					</div> --}}
