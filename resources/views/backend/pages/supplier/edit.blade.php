  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-header">
        <div class="row">
          <div class="col-md-6"><h2><i class="fa fa-plus-square"></i> {{ __('backend/default.edit_supplier') }}</h2></div>
      ...
      <div class="card-body">
        ...
        <form class="form-horizontal" id="myform" action="{{ route('admin.supplier.edit', $supplier->id) }}" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-5">
              <input id="name" class="form-control" value="{{$supplier->name}}" type="text" name="name"  required>
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-5">
              <input id="mobile" class="form-control" value="{{$supplier->mobile}}" type="text" name="mobile"  required>
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-5">
              <input id="email" class="form-control" value="{{$supplier->email}}" type="text" name="email">
            </div>
          </div>
            ...
            <div class="col-md-5">
              <div class="row">
                <div class="col-md-7 pr-0">
                  <input id="initial_balance" class="form-control" value="{{abs($supplier->initial_balance)}}" type="text" name="initial_balance" value="0" required>
                </div>
                <div class="col-md-5">
                  <select name="type" class="form-control">
                    <option value="payable" {{$supplier->type=="payable"?"selected":""}}>Payable</option>
                    <option value="revceivable" {{$supplier->type=="revceivable"?"selected":""}}>Revceivable</option>
                  </select>
                </div>
              </div>
            </div>
