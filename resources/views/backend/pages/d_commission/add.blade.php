...
@section('fav_title', __('backend/d_commission.add_d_commission') )
	...
	<div class="col-md-12">
		<div class="card">
			<div class="card-header">
				<div class="row">
					<div class="col-md-6"><h2><i class="{{ 'fa fa-plus-square' }}"></i> {{ __('backend/default.add_d_commission') }}</h2></div>
			...
			<div class="card-body">
				...
				<form class="form-horizontal" action="{{ route('admin.d_commission.store') }}" method="post" enctype="multipart/form-data">
					@csrf


					<div class="form-group">
						<label for="commission">Commission Amount</label>
						<input type="number" min="0" step="any" class="form-control" name="commission" id="commission" placeholder="Enter commission amount...">
					</div>
