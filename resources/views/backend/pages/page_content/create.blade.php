...
@section('fav_title', 'Add Page Content')
	...
	<div class="col-md-12">
		<div class="card">
			<div class="card-header">
				<div class="row">
					<div class="col-md-6"><h2><i class="fa fa-plus-square"></i>&nbsp;{{ __('backend/page_content.page_content') .' '. __('backend/default.create') }}</h2></div>
			...
			<div class="card-body">
				...
				<form class="form-horizontal" action="{{ route('admin.page_content.store') }}" method="post" enctype="multipart/form-data">
					@csrf
					<div class="form-group row">
						...
						<div class="col-md-6">
							...
							<div>
								<input type="text" class="form-control avro_bn" name="name_bn" id="name_bn" required>
							</div>
						</div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-md-6">
							...
							<div>
								<input type="text" class="form-control avro_bn" name="title_bn" id="title_bn" required>
							</div>
						</div>
					</div>
					...
					<div class="form-group row">
						<div class="col-md-6">
							...
							<textarea type="text" class="form-control" name="description_en" id="description_en" style="min-height: 166px;" required></textarea>
						</div>
						<div class="col-md-6">
							...
							<textarea type="text" class="form-control avro_bn" name="description_bn" id="description_bn" style="min-height: 166px;" required></textarea>
						</div>
					</div>
