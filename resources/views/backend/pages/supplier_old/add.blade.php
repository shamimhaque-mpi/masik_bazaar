        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" id="myform" action="{{ route('admin.supplier') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            <label class="control-label col-md-3 text-right">Photo <span class="text-danger">*</span></label>
                            <div class="col-md-5">
                                <input id="iamge" class="form-control" type="file" name="image"  required>
                            </div>
                        </div>
