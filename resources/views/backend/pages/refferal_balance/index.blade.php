...
@section('fav_title', __('backend/refferal_balance.refferal_balance') )
...
<div class="app-title">
	<div>
		<h1><i class="{{ 'fa fa-credit-card-alt' }}"></i> {{ __('backend/refferal_balance.refferal_balance_management') }}</h1>
	</div>
	<ul class="app-breadcrumb breadcrumb">
		<li class="breadcrumb-item"><a href="{{ route('admin.home') }}">{{ __('backend/default.dashboard') }}</a></li>
		<li class="breadcrumb-item active">{{ __('backend/refferal_balance.refferal_balance') }}</li>
	</ul>
</div>
	...
	<div class="col-md-12">
		<div class="card">
			...
			<div class="card-header">
				<div class="row">
					<div class="col-md-6"><h2><i class="{{ 'fa fa-table' }}"></i> {{ __('backend/refferal_balance.refferal_balance_list') }}</h2></div>
					{{-- <div class="col-md-6"><a href="{{ route('admin.refferal_balance.add') }}" class="float-right btn btn-primary"><i class="fa fa-plus"></i> {{ __('backend/default.add_new') }}</a></div> --}}
